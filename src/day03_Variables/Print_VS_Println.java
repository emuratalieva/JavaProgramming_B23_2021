...
public class Print_VS_Println {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("JRE stands for Java Runtime Environment, JAVAC stands for Java Compiler, JDK stands for Java Development Kit, JVM stands for Java Vritual Machine");
